...
ds = load_from_disk("tokenizedDatasets/tiny-pubmed-256") #This dataset is the tokenized version of the PubMed dataset, tokenized with the "huawei-noah/TinyBERT_General_4L_312D" tokenizer from Huggingface. The preprocessing.py can be used to reproduce this dataset.

modelPath = "huawei-noah/TinyBERT_General_4L_312D"
...
savePath = "distil-biobert/models/bio-tinybert/"
