...
ds = load_from_disk("tokenizedDatasets/mobile-pubmed-256") #This dataset is the tokenized version of the PubMed dataset, tokenized with the "google/mobilebert-uncased" tokenizer from Huggingface. The preprocessing.py can be used to reproduce this dataset.

modelPath = "google/mobilebert-uncased"
...
savePath = "distil-biobert/models/bio-mobilebert/"
